...
ggplot(gss_ad, aes(y = forcats::fct_rev(forcats::fct_infreq(haven::as_factor(discaff)))))+
  geom_bar() + 
...
```{r}
ggplot(gss_ad, aes(y = forcats::fct_rev(forcats::fct_infreq(haven::as_factor(affrmact))))) + 
  geom_bar() + 
